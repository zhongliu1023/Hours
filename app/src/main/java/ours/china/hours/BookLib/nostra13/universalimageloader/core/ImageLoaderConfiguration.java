 ...
 *******************************************************************************/
package ours.china.hours.BookLib.nostra13.universalimageloader.core;

import android.content.Context;
import android.content.res.Resources;
import android.util.DisplayMetrics;

import ours.china.hours.BookLib.nostra13.universalimageloader.cache.disc.DiskCache;
import ours.china.hours.BookLib.nostra13.universalimageloader.cache.disc.naming.FileNameGenerator;
import ours.china.hours.BookLib.nostra13.universalimageloader.cache.memory.MemoryCache;
import ours.china.hours.BookLib.nostra13.universalimageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import ours.china.hours.BookLib.nostra13.universalimageloader.core.assist.FlushedInputStream;
import ours.china.hours.BookLib.nostra13.universalimageloader.core.assist.ImageSize;
import ours.china.hours.BookLib.nostra13.universalimageloader.core.assist.QueueProcessingType;
import ours.china.hours.BookLib.nostra13.universalimageloader.core.decode.ImageDecoder;
import ours.china.hours.BookLib.nostra13.universalimageloader.core.download.ImageDownloader;
import ours.china.hours.BookLib.nostra13.universalimageloader.core.process.BitmapProcessor;
import ours.china.hours.BookLib.nostra13.universalimageloader.utils.L;
import ours.china.hours.BookLib.nostra13.universalimageloader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link ours.china.hours.BookLib.nostra13.universalimageloader.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, ours.china.hours.BookLib.nostra13.universalimageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link ours.china.hours.BookLib.nostra13.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link ours.china.hours.BookLib.nostra13.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link ours.china.hours.BookLib.nostra13.universalimageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(ours.china.hours.BookLib.nostra13.universalimageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link ours.china.hours.BookLib.nostra13.universalimageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(ours.china.hours.BookLib.nostra13.universalimageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link ours.china.hours.BookLib.nostra13.universalimageloader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link ours.china.hours.BookLib.nostra13.universalimageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link ours.china.hours.BookLib.nostra13.universalimageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link ours.china.hours.BookLib.nostra13.universalimageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link ours.china.hours.BookLib.nostra13.universalimageloader.utils.L#disableLogging()} to disable
	 ...
	 * using {@link ours.china.hours.BookLib.nostra13.universalimageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
