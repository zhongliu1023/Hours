...
public class WebViewUtils {
    ...
    public static void renterToPng(String name, String content, final OutputStream os, final Object lock) {
        if (web == null) {
            synchronized (lock) {
                lock.notify();
            }
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                web.addJavascriptInterface(new WebAppInterface(new Runnable() {
                    @Override
                    public void run() {
