...
public class PopupHelper {
    ...
    public static void addPROIcon(final PopupMenu menu, final Context c) {
        if (!AppsConfig.checkIsProInstalled(c)) {
            menu.getMenu().add("Librera PRO").setIcon(R.mipmap.ic_launcher).setOnMenuItemClickListener(new OnMenuItemClickListener() {
    ...
    public static void addPROIcon(final MyPopupMenu menu, final Context c) {
        ...
        if (!AppsConfig.checkIsProInstalled(c)) {
            menu.getMenu().add(R.string.app_name_pro).setIcon(R.mipmap.ic_launcher).setOnMenuItemClickListener(new OnMenuItemClickListener() {
