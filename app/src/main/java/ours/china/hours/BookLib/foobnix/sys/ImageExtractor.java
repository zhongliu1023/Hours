package ours.china.hours.BookLib.foobnix.sys;
...
import ours.china.hours.BookLib.foobnix.ext.CbzCbrExtractor;
...
import ours.china.hours.BookLib.foobnix.ext.OdtExtractor;
...
import ours.china.hours.BookLib.foobnix.opds.OPDS;
...
//            }
    ...
    public static synchronized CodecDocument getNewCodecContext(final String path, String
        ...
        pageCount = 0;//codeCache.getPageCount(w, h, BookCSS.get().fontSizeSp);
        pathCache = path;
        whCache = h + w;
        return codeCache;
