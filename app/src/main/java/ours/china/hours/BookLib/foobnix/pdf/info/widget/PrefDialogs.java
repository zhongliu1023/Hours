...
import ours.china.hours.BookLib.foobnix.pdf.info.ExtFilter;
...
import ours.china.hours.BookLib.foobnix.pdf.info.presentation.BrowserAdapter;
import ours.china.hours.BookLib.foobnix.pdf.info.presentation.PathAdapter;
...
public class PrefDialogs {
    ...
    public static void importDialog(final FragmentActivity activity) {
        ...
        ChooserDialogFragment.chooseFile(activity, sampleName).setOnSelectListener(new ResultResponse2<String, Dialog>() {
            ...
            @Override
            public boolean onResultRecive(final String result1, final Dialog result2) {
    ...
    public static void exportDialog(final FragmentActivity activity) {
        ...
        ChooserDialogFragment.createFile(activity, sampleName).setOnSelectListener(new ResultResponse2<String, Dialog>() {
            ...
            @SuppressLint("StaticFieldLeak")
            @Override
            public boolean onResultRecive(String result1, final Dialog result2) {
                final File toFile = new File(result1);
    ...
    public static void selectFileDialog(final Context a, List<String> browseexts, File path, final ours.china.hours.BookLib.foobnix.android.utils.ResultResponse<String> onChoose) {
