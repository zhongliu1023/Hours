...
public class ListBoxHelper {
    ...
    public static void showAddDialog(final DocumentController controller, final List<AppBookmark> objects, final BookmarksAdapter bookmarksAdapter, String text, final Runnable onRefresh) {
        ...
        final CheckBox isFloat = new CheckBox(a);
    ...
    public static void showEditDeleteDialog(final AppBookmark bookmark, DocumentController controller, final BookmarksAdapter bookmarksAdapter, final List<AppBookmark> objects, final Runnable onRefresh) {
        ...
        final CheckBox isFloat = new CheckBox(controller.getActivity());
