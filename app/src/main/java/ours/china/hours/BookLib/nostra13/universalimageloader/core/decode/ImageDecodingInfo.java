...
import ours.china.hours.BookLib.nostra13.universalimageloader.core.DisplayImageOptions;
...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain ours.china.hours.BookLib.nostra13.universalimageloader.utils.MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache). */
