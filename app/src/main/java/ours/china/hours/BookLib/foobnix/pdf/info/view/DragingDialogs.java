...
import ours.china.hours.BookLib.foobnix.StringResponse;
import ours.china.hours.BookLib.foobnix.android.utils.BaseItemAdapter;
...
import ours.china.hours.BookLib.foobnix.android.utils.MemoryUtils;
...
import ours.china.hours.BookLib.foobnix.pdf.info.model.AnnotationType;
import ours.china.hours.BookLib.foobnix.pdf.info.model.BookCSS;
import ours.china.hours.BookLib.foobnix.pdf.info.model.BookCSS.FontPack;
...
import ours.china.hours.BookLib.foobnix.pdf.info.presentation.PageThumbnailAdapter;
import ours.china.hours.BookLib.foobnix.pdf.info.widget.ChooserDialogFragment;
import ours.china.hours.BookLib.foobnix.pdf.info.widget.ColorsDialog;
import ours.china.hours.BookLib.foobnix.pdf.info.widget.ColorsDialog.ColorsDialogResult;
import ours.china.hours.BookLib.foobnix.pdf.info.widget.DialogTranslateFromTo;
import ours.china.hours.BookLib.foobnix.pdf.info.widget.FontDialog;
import ours.china.hours.BookLib.foobnix.pdf.info.widget.TapZoneDialog;
...
import ours.china.hours.BookLib.foobnix.pdf.search.menu.MenuBuilderM;
...
import ours.china.hours.BookLib.foobnix.tts.TTSTracks;
    ...
    public static DragingPopup thumbnailDialog(final FrameLayout anchor, final DocumentController dc) {
        ...
        DragingPopup popup = new DragingPopup(R.string.go_to_page_dialog, anchor, 300, 400) {
            ...
            public void beforeCreate() {
                ...
                titlePopupMenu.getMenu().addCheckbox(dc.getString(R.string.show_search_bar), AppState.get().isShowSearchBar, new OnCheckedChangeListener() {
                    @Override
                ...
                titlePopupMenu.getMenu().addCheckbox(dc.getString(R.string.show_fast_scroll), AppState.get().isShowFastScroll, new OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            public View getContentView(LayoutInflater inflater) {
                ...
                grid.setOnItemLongClickListener(new OnItemLongClickListener() {
                    ...
                    public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                        ...
                        menu.getMenu().add(R.string.share_as_text).setIcon(R.drawable.glyphicons_basic_578_share).setOnMenuItemClickListener(new OnMenuItemClickListener() {
                            @Override
                        ...
                        menu.getMenu().add(R.string.share_as_image).setIcon(R.drawable.glyphicons_1_picture).setOnMenuItemClickListener(new OnMenuItemClickListener() {
                            @Override
                            public boolean onMenuItemClick(MenuItem it) {
                        ...
                        menu.getMenu().add(R.string.copy_text).setIcon(R.drawable.glyphicons_basic_614_copy).setOnMenuItemClickListener(new OnMenuItemClickListener() {
                            @Override
                            public boolean onMenuItemClick(MenuItem it) {
    ...
    public static DragingPopup statusBarSettings(final FrameLayout anchor, final DocumentController controller, final Runnable onRefresh, final Runnable updateUIRefresh) {
        ...
        DragingPopup dialog = new DragingPopup(R.string.status_bar, anchor, PREF_WIDTH, PREF_HEIGHT) {
            ...
            public View getContentView(final LayoutInflater inflater) {
                ...
                isShowLineDividing.setOnCheckedChangeListener(new OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                isShowLastPageRed.setOnCheckedChangeListener(new OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
    ...
    public static DragingPopup performanceSettings(final FrameLayout anchor, final DocumentController controller, final Runnable onRefresh, final Runnable updateUIRefresh) {
        ...
        DragingPopup dialog = new DragingPopup(R.string.advanced_settings, anchor, PREF_WIDTH, PREF_HEIGHT) {
            ...
            public View getContentView(final LayoutInflater inflater) {
                ...
                final CheckBox highlightByLetters = (CheckBox) inflate.findViewById(R.id.highlightByLetters);
                ...
                final CheckBox isSelectTexByTouch = (CheckBox) inflate.findViewById(R.id.isSelectTexByTouch);
                ...
                isSelectTexByTouch.setOnCheckedChangeListener(new OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            public View getContentView(final LayoutInflater inflater) {
                ...
                inflate.findViewById(R.id.onFullScreen).setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        DocumentController.showFullScreenPopup(controller.getActivity(), v, new IntegerResponse() {
                            @Override
                            public boolean onResultRecive(int id) {
