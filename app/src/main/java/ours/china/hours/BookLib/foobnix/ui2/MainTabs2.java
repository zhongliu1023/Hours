...
import ours.china.hours.BookLib.foobnix.android.utils.Safe;
...
import ours.china.hours.BookLib.foobnix.pdf.SlidingTabLayout;
import ours.china.hours.BookLib.foobnix.pdf.info.Android6;
import ours.china.hours.BookLib.foobnix.pdf.info.AppsConfig;
import ours.china.hours.BookLib.foobnix.pdf.info.ExportConverter;
import ours.china.hours.BookLib.foobnix.pdf.info.ExportSettingsManager;
...
import ours.china.hours.BookLib.foobnix.ui2.adapter.TabsAdapter2;
import ours.china.hours.BookLib.foobnix.ui2.fragment.BookmarksFragment2;
import ours.china.hours.BookLib.foobnix.ui2.fragment.BrowseFragment2;
import ours.china.hours.BookLib.foobnix.ui2.fragment.OpdsFragment2;
import ours.china.hours.BookLib.foobnix.ui2.fragment.PrefFragment2;
import ours.china.hours.BookLib.foobnix.ui2.fragment.RecentFragment2;
import ours.china.hours.BookLib.foobnix.ui2.fragment.SearchFragment2;
...
public class MainTabs2 extends FragmentActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_ADD_RESOURCE && resultCode == Activity.RESULT_OK) {
            ...
            StringDB.add(BookCSS.get().pathSAF, pathSAF, new StringResult() {
                @Override
    ...
    public static boolean isPullToRefreshEnable(Context a, View swipeRefreshLayout) {
        ...
        return AppTemp.get().isEnableSync && BookCSS.get().isSyncPullToRefresh;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (BOOKS.getAll() != null && !BOOKS.getAll().isEmpty()) {
            final File oldConfig = new File(AppProfile.SYNC_FOLDER_ROOT, Build.MODEL.replace(" ", "_") + "-backup-v8.0.json");
            if (!oldConfig.exists()) {
