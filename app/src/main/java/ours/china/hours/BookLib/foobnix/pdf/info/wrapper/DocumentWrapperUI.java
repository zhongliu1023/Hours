...
import ours.china.hours.BookLib.foobnix.pdf.info.OutlineHelper.Info;
...
import ours.china.hours.BookLib.foobnix.pdf.info.view.DrawView;
...
import ours.china.hours.BookLib.foobnix.pdf.info.view.ProgressDraw;
import ours.china.hours.BookLib.foobnix.pdf.info.view.UnderlineImageView;
...
//        }
    ...
    public void initUI(final Activity a) {
        ...
        textToSpeach.setOnLongClickListener(new OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
    ...
    public View.OnClickListener onFull = new View.OnClickListener() {
        ...
        @Override
        public void onClick(final View v) {
            DocumentController.showFullScreenPopup(dc.getActivity(), v, new IntegerResponse() {
                @Override
