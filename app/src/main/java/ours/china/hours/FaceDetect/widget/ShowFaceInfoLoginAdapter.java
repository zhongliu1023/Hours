...
public class ShowFaceInfoLoginAdapter extends RecyclerView.Adapter<ShowFaceInfoLoginAdapter.CompareResultHolder> {
    private List<CompareResult> compareResultList;
    private LayoutInflater inflater;

    public ShowFaceInfoLoginAdapter(List<CompareResult> compareResultList, Context context) {
    ...
    public CompareResultHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = inflater.inflate(R.layout.face_login_head, null, false);
